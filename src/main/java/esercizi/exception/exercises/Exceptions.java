package esercizi.exception.exercises;
...
public class Exceptions {
     ...
     */
    public static void checkStringP(String s) throws ParseException {
     ...
     */
    public static void removeItemsP(List<String> strings) {
     ...
     * the caller.
     */
    public static boolean checkIntervalP(String begin, String end) throws ParseException {
