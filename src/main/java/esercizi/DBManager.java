...
public class DBManager {
    ...
    public static final String JDBC_URL_MySQL = "jdbc:mysql://localhost:3306/jdbc_schema?user=federico&password=fe21de21&serverTimezone=" + TimeZone.getDefault().getID();
